...
import { ComplementarBicPageComponent } from '../complementar-bic/complementar-bic';
...
@Component({
  selector: 'page-consulta-complementar-bic',
  templateUrl: 'consulta-complementar-bic.html'
})
export class ConsultaComplementarBicPageComponent implements OnInit {
  ...
  OnSelectBIC(bic) {
    if (bic !== null || bic !== undefined) {
      this.msicoWebServices.loadDetailsBICDetails(bic, 'altera').subscribe(
        data => {
          let dataRetrieved: any = data;
          ...
          /*this.navCtrl.push(ComplementarBicPageComponent, {
            initialData: this.detailsBIC,
            initialList: this.detailsBIC.listagensDominio
          });*/

          this.navCtrl.navigateForward('complementarBic', {
            state: {
              initialData: this.detailsBIC,
              initialList: this.detailsBIC.listagensDominio
            }
